    ...
    <header>
      <div className="flex flex-col px-4 pt-4 mx-8 mx-auto text-black roboto-regular max-w-7xl md:mx-10 lg:mx-20 xl:mx-auto md:flex-row md:items-center md:justify-between">
        <div className="flex flex-row items-center justify-between p-4">
          <a href="/" className="text-4xl font-semibold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-pink-300 via-red-300 to-amber-300 md:text-gray-900">
            Uranium
          </a>
          <button
        ...
        >
          <div className="flex-col pl-4 text-xl md:flex-grow md:pl-0">
            <ul className="flex flex-wrap items-center justify-end flex-grow gap-2 pr-4 space-x-2 md:gap-6 md:space-x-6">
              <li>
                <a href="#" className="text-lg text-white md:text-black">
                    Product
                </a>
              </li>
              <li>
